...
def retrieve_config():
    config = {'MAX_EPSILON'  : 1,
                ...
                'NUM_EPISODES' : 25, # Max number of episodes to play, if you want to keep playing until MIN_LOSS is reached, make this number high
                'PRINT_EVERY'  : 5,  # Shows a plot of rewards per player every ~ episodes
